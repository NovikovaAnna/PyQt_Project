...
class Window(QtWidgets.QWidget):
    ...
    def initUi(self) -> None:
        ...
        layoutButtons.addWidget(labelRegistration)  # TODO с помощью метода .addWidget() добавьте self.pushButtonLogin
        layoutButtons.addWidget(self.lineEditPassword)  # TODO с помощью метода .addWidget() добавьте self.pushButtonRegistration
